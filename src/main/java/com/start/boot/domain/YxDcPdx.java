 ...
 * @author 
 */
public class YxDcPdx extends YxDcPdxKey implements Serializable {
    private String pdxmc;

    private String pdxflbm;

    private String dcmbbm;

    private String ajlbbm;

    private String ajlbmc;

    private BigDecimal pdxlx;
    ...
    public String getPdxmc() {
        return pdxmc;
    }

    public void setPdxmc(String pdxmc) {
        this.pdxmc = pdxmc;
    }

    public String getPdxflbm() {
        return pdxflbm;
    }

    public void setPdxflbm(String pdxflbm) {
        this.pdxflbm = pdxflbm;
    }

    public String getDcmbbm() {
        return dcmbbm;
    }

    public void setDcmbbm(String dcmbbm) {
        this.dcmbbm = dcmbbm;
    }
    ...
    public BigDecimal getPdxlx() {
        return pdxlx;
    }

    public void setPdxlx(BigDecimal pdxlx) {
        this.pdxlx = pdxlx;
    }
