...
(function ($) {
    ...
    $.fn._zoomValue = function () {
        var zoom = 1.0;
        var sWidth = $(window).width();
        if(sWidth > 1210 && sWidth < 1370){
            zoom = 0.7;
        } else if (sWidth > 1370 && sWidth < 1450){
            zoom = 0.75;
        } else if (sWidth > 1450 && sWidth < 1610){
            zoom = 0.82;
        } else if (sWidth > 1610 && sWidth < 1690){
            zoom = 0.9;
        }
        return zoom;
    };
        ...
        return this.each(function () {
            ...
            function _7a(e) {
                ...
                if (e.pageX > _7d.left && e.pageX < _7d.left + _80) {
                    ...
                    var xLocation = e.pageX / $(this)._zoomValue();
                    if (xLocation < _7d.left + _7e && xLocation > _7d.left + _7e - _80) {
                        dir += "e";
                    }
                }
...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        ...
        beforePageText: "页码：",
        afterPageText: "/{pages}",
        displayMsg: "【数据项:{from} 至 {to}】  【总记录:{total}】",
        nav: {
            first: {
...
(function ($) {
    ...
    function _27d(_27e) {
        ...
        /*ZJY:20171112,解决文书控件掩盖弹窗问题。*/
        _27f.window.append("<iframe style='position:absolute;z-index:-1;width:100%;height:100%;left:0;top:0;scrolling:no;border-left:0;border-top:0;' frameborder='0'></iframe>");
        ...
        _3a8.resizable($.extend({}, {
            handles: (_3a7[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                ...
                if (dir == "north" || dir == "south") {
                    ...
                    _3ac.css("left", e.pageX / zoom - $(_3a1).offset().left - _3ac.width() / 2);
                }
                return false;
            }, onStopResize: function (e) {
...
(function ($) {
        ...
        _61a.each(function () {
            $(this).resizable({
                ...
                onStartResize: function (e) {
                    ...
                    var zoom = $(this)._zoomValue();
                    _617.proxy.css({left: e.pageX / zoom + 5 - $(_618).offset().left - 1, display: "none"});
                    setTimeout(function () {
                        if (_617.proxy) {
                            _617.proxy.show();
                        }
                ...
                onResize: function (e) {
                    var zoom = $(this)._zoomValue();
                    _617.proxy.css({left: e.pageX / zoom + 5 - $(_618).offset().left - 1, display: "block"});
                    return false;
                },
                onStopResize: function (e) {
                    _619.css("cursor", "");
    ...
    function _698(_699, _69a) {
        ...
        if (tr.length) {
            ...
            if (top < 0) {
                // 修正分组datagrid点击数据滚动条上移问题， 2018.01.14
               // _69d.scrollTop(_69d.scrollTop() + top);
            } else {
                // 修正datagrid数据量大，超过50条时，点击数据滚动条上移问题， 2018.01.26
    ...
    var _77a = {
        render: function (_77b, _77c, _77d) {
            ...
            _7a5.call(this, true);
            var tableName = this.updateRow.arguments[0].id;
            if("table_handle_new_pcx" != tableName){
                _7a5.call(this, false); //解决datagrid俩列合并后，调用updateRow方法引起列变动问题
            }
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showHeader: true,
        showFooter: false,
        scrollbarSize: 4, //2018.01.26修改，滚动条样式变化引起滚动条宽度变化，造成DataGrid表头列与内容列错位，原值：18
