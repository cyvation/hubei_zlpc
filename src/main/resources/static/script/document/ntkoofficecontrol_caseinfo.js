...
function OnComplete3_caseinfo(str, doc) {
    TANGER_OCX_OBJ_READONLY.activeDocument.saved = true; //saved属性用来判断文档是否被修改过,文档打开的时候设置成ture,当文档被修改,自动被设置为false,该属性由office提供.
    //	TANGER_OCX_OBJ_READONLY.SetReadOnly(true,"");
    //TANGER_OCX_OBJ_READONLY.ActiveDocument.Protect(1,true,"123");
    //获取文档控件中打开的文档的文档类型
    switch (TANGER_OCX_OBJ_READONLY.doctype) {
        case 1:
    ...
    //    if (TANGER_OCX_OBJ_READONLY.ToolBars == false) {
...
if (browser == "IE") {
    ...
    html += '<object id="TANGER_OCX_CASEINFO" classid="clsid:6AA93B4B-D450-4a80-876E-3909055B0640"';
    ...
    html += '<object id="TANGER_OCX_CASEINFO" type="application/ntko-plug"  codebase="plugin/officecontrol/OfficeControl.cab#version=5,0,2,2" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"';
    ...
    html += '<embed id="TANGER_OCX_CASEINFO" wmode="transparent" clsid="{6AA93B4B-D450-4a80-876E-3909055B0640}" OnFileCommand="FileCommand11" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3_caseinfo"';
    html += 'ForOnpublishAshtmltourl="publishashtml"';
    html += 'ForOnpublishAspdftourl="publishaspdf"';
    html += 'ForOnSaveAsOtherFormatToUrl="saveasotherurl"';
    html += 'ForOnDoWebGet="dowebget"';
    html += 'ForOnDoWebExecute="webExecute"';
    html += 'ForOnDoWebExecute2="webExecute2"';
    html += 'ForOnFileCommand="save_document_file"';
    html += 'ForOnCustomMenuCmd2="CustomMenuCmd"';
    html += '_MakerCaption="成都赛威讯信息技术研究所"';
    html += '_MakerKey="A3F9C486F1E1E469380C0A494394F9F7D58402D0"';
    html += '_ProductCaption="案件质量评查" ';
