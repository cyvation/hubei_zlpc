...
if (browser == "IE") {
    ...
    html += '<object id="TANGER_OCX_PCXX" classid="clsid:6AA93B4B-D450-4a80-876E-3909055B0640"';
    ...
    html += '<object id="TANGER_OCX_PCXX" type="application/ntko-plug"  codebase="plugin/officecontrol/OfficeControl.cab#version=5,0,2,2" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"';
    ...
    html += '<embed id="TANGER_OCX_PCXX" wmode="transparent" clsid="{6AA93B4B-D450-4a80-876E-3909055B0640}" OnFileCommand="FileCommand11" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"';
    html += 'ForOnpublishAshtmltourl="publishashtml"';
    html += 'ForOnpublishAspdftourl="publishaspdf"';
    html += 'ForOnSaveAsOtherFormatToUrl="saveasotherurl"';
    html += 'ForOnDoWebGet="dowebget"';
    html += 'ForOnDoWebExecute="webExecute"';
    html += 'ForOnDoWebExecute2="webExecute2"';
    html += 'ForOnFileCommand="pcWin_save_doc_file"';
    html += 'ForOnCustomMenuCmd2="CustomMenuCmd"';
    html += '_MakerCaption="成都赛威讯信息技术研究所"';
    html += '_MakerKey="A3F9C486F1E1E469380C0A494394F9F7D58402D0"';
    html += '_ProductCaption="案件质量评查" ';
