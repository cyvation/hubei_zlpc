...
$(document).ready(function () {
    // console.log(111111);
    grid_handle_table_bm()
});
function grid_handle_table_bm() {
    var obj = new Object();
    obj.dwbm =370000;
    $('#grid_handle_table_yscx').datagrid({
        ...
        // idField: 'pcxbm',
        //loadMsg: '数据加载中，请稍后...',
        url:getRootPath() + '/queryTable/getDwTableData?dwbm=370000',
        //data:obj,
        pagination: false,
        columns: [[
            {
                ...
                formatter: function (value, row, index) {
                    if(value!='合计'){
                        return  '<a href="#" style="color: #145bae;text-decoration: none;"  onclick="alert_win_handle_grade_adjust(\'' + index + '\')">'+value+'</a> ';
                    }else {
...
//         // idField: 'pcxbm',
//         //loadMsg: '数据加载中，请稍后...',
//         url:getRootPath() + '/queryTable/getBmTableData?dwbm=370000',
//         //data:obj,
//         pagination: false,
//         columns: [[
//             {
...
//
// }
//  function grid_handIe_table_list(caseInfo) {
//         var obj = new Object();
...
//                 if(result.code==200){
//                     $('#grid_handle_table_yscx').datagrid('loadData',result.data);
//                 }else {
//                     return [];
//                 }
//             }
...
function alert_win_handle_grade_adjust(pcspbm, pcslbm, spjsmc) {
